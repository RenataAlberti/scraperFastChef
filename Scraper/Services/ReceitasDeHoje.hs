...
module Scraper.Services.ReceitasDeHoje where
...
searchReceitasDeHoje :: String -> IO [Recipes]
searchReceitasDeHoje x = do
...
viewReceitasDeHoje :: String -> IO Recipe
viewReceitasDeHoje x = do
